...
export default async function Termsit() {
  const locale = 'it';
          ...
          <div className="mb-6 pb-6 border-b border-[#5E4CC9]/30">
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-[#4947C7]/20 to-[#7B6FE8]/20 border border-[#4947C7]/40 rounded-lg">
              <p className="text-sm text-gray-300">
                <strong className="text-white">Nota:</strong> Il contenuto completo dei termini di servizio è attualmente disponibile in inglese. La traduzione italiana sarà disponibile a breve.
              </p>
            </div>
          </div>
