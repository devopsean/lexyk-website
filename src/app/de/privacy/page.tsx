...
export default async function Privacyde() {
  const locale = 'de';
          ...
          <div className="mb-6 pb-6 border-b border-[#5E4CC9]/30">
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-[#4947C7]/20 to-[#7B6FE8]/20 border border-[#4947C7]/40 rounded-lg">
              <p className="text-sm text-gray-300">
                <strong className="text-white">Hinweis:</strong> Der vollständige Inhalt der Datenschutzrichtlinie ist derzeit nur auf Englisch verfügbar. Die deutsche Übersetzung wird in Kürze verfügbar sein.
              </p>
            </div>
          </div>
