    ...
    <div className="relative -translate-y-20 sm:-translate-y-32 md:-translate-y-40 lg:-translate-y-[230px] over-2000:-translate-y-[13vw]">
      ...
      <div className="max-w-6xl over-2000:max-w-[60vw] mx-auto pt-16 sm:pt-24 md:pt-28 lg:pt-[138px] over-2000:pt-[8vw] px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-gray-300 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl over-2000:text-[1.25vw]/[2vw] max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl over-1700:max-w-[55vw] over-2000:max-w-[40vw] mx-auto font-medium px-4">
            {STRINGS.sectionabt2}
          </p>
        </div>        
      </div>
